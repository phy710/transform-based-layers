...
if __name__ == '__main__':
    ...
    parser.add_argument('-a', '--arch', metavar='ARCH', default='bwt_resnet50',
                        choices=model_names,
    ...
    parser.add_argument('-b10', '--batch-size10', default=256, type=int,
                        metavar='N',
                        help='mini-batch size for 10-crop (default: 256), this is the total '
                             'batch size of all GPUs on the current node when '
                             'using Data Parallel or Distributed Data Parallel')
